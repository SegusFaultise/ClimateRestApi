...
namespace CLIMATE_REST_API.Services
{
    ...
    public class MongoDBServices
    {
        ...
        IOptions<MongoDBSettings> mongodbSettings)
        {
            ...
            _weatherCollection = 
            database.GetCollection<SensorDataModel>(
            mongodbSettings
            .Value
            .Collection1);
        ...
        public async Task<string> GetMaxPrecipitaionAsync(
        string device)
        {
            var device_filter =
            Builders<SensorDataModel>
        ...
        public async Task<string> GetFieldsBasedOnTimeAndDateAsync(
        string device,
        DateTime date_time)
        {
            var device_filter =
            ...
            new
            {
                ...
                u.AtmosphericPressure_kPa,
                Temperature_C =
                u.Temperature_C,
                SolarRadiation_Wm2 =
                u.SolarRadiation_Wm2
            });
        ...
        public async Task<string> GetMaxTempAsync(
        ...
        public async Task CreateWeatherAsync(
        SensorDataModel weather)
        {
            await _weatherCollection
            .InsertOneAsync(
            weather);
        ...
        public async Task CreateMannyWeatherAsync(
        List<SensorDataModel> weather)
        { 
        ...
        public async Task UpdatePrecipitaionAsync(
        string id,
        double precipitation_mm_h)
        {
            FilterDefinition<SensorDataModel> filter =
            Builders<SensorDataModel>
            .Filter
            .Eq(
            "Id",
            ...
            UpdateDefinition<SensorDataModel> update =
            Builders<SensorDataModel>
            .Update
            .Set(
            "Precipitation mm/h",
        ...
        public async Task<UserModel?> AuthenticateUserAsync(
        string api_token,
        string role)
        {
            var api_token_filter =
            Builders<UserModel>
            .Filter
            .Eq(
            u => 
        ...
        public async Task<bool> CreatedUserAsync(
        ...
        string id)
        {
            ...
            await _userCollection.DeleteOneAsync(
            filter);
        ...
        public async Task<UserModel> DeletesManyUsersAsync(
        string api_token,
        DateTime date_time_start,
        DateTime date_time_end)
        {
            var filter_date_time_start =
            Builders<UserModel>
            .Filter
            .Gte(
            u => 
            ...
            .Filter
            .And(
            filter_date_time_start,
            filter_date_time_end);

            var users = 
            _userCollection.Find(
            filters)
            .FirstOrDefault();
            ...
            await _userCollection.DeleteManyAsync(
            filters);
        ...
        public async Task UpdateUserLoginTimeAsync(
        string api_token, 
        ...
        public async Task<UserModel?> PatchUsersRoleAsync(
        string property, 
        object value, 
        DateTime date_time_start, 
        DateTime date_time_end)
        {
            ...
            await _userCollection.UpdateManyAsync(
            filters, 
            value_property_update);
