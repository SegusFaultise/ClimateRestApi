...
namespace CLIMATE_DATA_BRAZIL.Controllers
{
    ...
    public class SensorController : Controller
    {
        ...
        {
            var authenticate = await _mongodbServices.AuthenticateUserAsync(api_token, role);
        ...
        public async Task<IActionResult> PostSingleSensorAsync([FromBody] SensorDataModel sensor_model)
        {
            try
            {
                if (sensor_model.Humidity_percentage + 
                ...
                else
                {
                    ...
                    new {id = sensor_model.Id }, sensor_model);
                }
            }
            catch
            {
        ...
        public async Task<IActionResult> PostMannyWeatherAsync([FromBody] List<SensorDataModel> sensor_model)
        {
            try
            {
                ...
                {
                    await _mongodbServices.CreateMannyWeatherAsync(sensor_model);

                    return CreatedAtAction(nameof(GetAllSensors), new {id = sensor_model }, sensor_model);
                }
            }
            catch
            {
